...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_iso_83(
         _______,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FILE,  UG_VALD,  UG_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_INS ,            KC_PSCR,
         _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
         UG_TOGG,  UG_NEXT,  UG_VALU,  UG_HUEU,  UG_SATU,  UG_SPDU,  _______,  _______,  _______,  _______,  _______,  _______,  _______,                      _______,
...
// Use key override to send END when pressing CTR + HOME
const key_override_t ctrl_home_end_override =
  ko_make_basic(MOD_MASK_CTRL, KC_HOME, KC_END);


// Use key override to send INS when pressing CTR + DEL
const key_override_t ctrl_del_ins_override =
  ko_make_basic(MOD_MASK_CTRL, KC_DEL, KC_INS);


const key_override_t *key_overrides[] = {
  &ctrl_home_end_override,
  &ctrl_del_ins_override,
      NULL
};